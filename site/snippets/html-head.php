...
<head>
	...
	<?php /* <link rel="alternate" type="application/rss+xml" title="<?php echo site()->title()->smartypants(); ?>: <?php echo page('blog')->title()->smartypants(); ?> Feed" href="<?php echo (c::get('url') != '/') ? site()->url() . '/blog.rss' : '/blog.rss'; ?>"> */ ?>
